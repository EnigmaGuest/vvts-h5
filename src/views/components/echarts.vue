<template>
  <div class="flex-col">
    <div class="flex-col p-12px bg-white dark:bg-dark rounded mb-[12px] overflow-y-scroll " >
      <div ref="pieRef" class="h-[400px] w-[800px] "></div>
    </div>
    <div class="flex-col p-12px bg-white dark:bg-dark rounded mb-[12px] overflow-y-scroll">
      <div ref="lineRef" class="h-[400px] w-[800px]"></div>
    </div>
    <div class="flex-col p-12px bg-white dark:bg-dark rounded mb-[12px] overflow-y-scroll">
      <div ref="barRef" class="h-[400px] w-[800px]" ></div>
    </div>
    <div class="flex-col p-12px bg-white dark:bg-dark rounded mb-[12px] overflow-y-scroll">
      <div ref="pictorialBarRef" class="h-[600px] w-[800px]"></div>
    </div>
    <div class="flex-col p-12px bg-white dark:bg-dark rounded mb-[12px] overflow-y-scroll">
      <div ref="scatterRef" class="h-[600px] w-[800px]"></div>
    </div>
    <div class="flex-col p-12px bg-white dark:bg-dark rounded mb-[12px] overflow-y-scroll">
      <div ref="radarRef" class="h-[400px] w-[800px]"></div>
    </div>
    <div class="flex-col p-12px bg-white dark:bg-dark rounded mb-[12px] overflow-y-scroll">
      <div ref="gaugeRef" class="h-[460px] w-[800px]"></div>
    </div>
  </div>
...
import { type ECOption, useEcharts } from '@/composables/index';
